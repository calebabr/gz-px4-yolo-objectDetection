    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'image_processing_msgs.msg.DetectionArray')
            logger.debug(
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        'detections': 'sequence<image_processing_msgs/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['image_processing_msgs', 'msg'], 'Detection')),  # noqa: E501
    )
