...
static const _ProminentObjectArray_type_support_symbol_names_t _ProminentObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_processing_msgs, msg, ProminentObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, image_processing_msgs, msg, ProminentObjectArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, image_processing_msgs, msg, ProminentObjectArray)() {
  return &::image_processing_msgs::msg::rosidl_typesupport_c::ProminentObjectArray_message_type_support_handle;
}
